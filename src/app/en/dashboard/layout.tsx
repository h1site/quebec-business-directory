...
export default function DashboardLayoutEN({
  children,
}: {
  ...
  useEffect(() => {
    supabase.auth.getSession().then(({ data: { session } }) => {
      if (!session) {
        router.push('/en/login?redirect=/en/dashboard')
      } else {
  ...
  const navItems = [
    ...
    { href: '/en/dashboard/businesses', label: 'My businesses', icon: '🏢' },
    { href: '/en/dashboard/profile', label: 'My profile', icon: '👤' },
    { href: '/en/dashboard/reviews', label: 'My reviews', icon: '⭐' },
  ]
        ...
        <div className="flex flex-col h-full">
          ...
          <div className="p-6 border-b border-gray-200">
            <Link href="/en" className="flex items-center gap-3">
              ...
              />
              <div>
                <span className="font-bold text-gray-900 block">Quebec Registry</span>
