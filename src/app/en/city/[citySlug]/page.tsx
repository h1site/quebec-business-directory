...
export async function generateMetadata({ params }: Props): Promise<Metadata> {
  ...
  return {
    title: `Businesses in ${cityName} - Quebec Business Registry`,
    description: `Find the best businesses in ${cityName}, Quebec. Complete directory with contact information, reviews and detailed information.`,
    alternates: {
      canonical: `https://registreduquebec.com/en/city/${citySlug}`,
      languages: {
    ...
    openGraph: {
      title: `Businesses in ${cityName} | Quebec Business Registry`,
      description: `Discover local businesses in ${cityName}. Complete directory with contact info and reviews.`,
      type: 'website',
      locale: 'en_CA',
...
export default async function CityPageEN({ params, searchParams }: Props) {
  const { citySlug } = await params
  ...
  const jsonLd = {
    ...
    description: `Business directory in ${cityName}, Quebec`,
    url: `https://registreduquebec.com/en/city/${citySlug}`,
  }
        ...
        <section className="relative bg-gradient-to-br from-blue-900 to-blue-700 text-white py-12 overflow-hidden">
          ...
          <div className="relative z-10 max-w-6xl mx-auto px-4">
            ...
            <nav className="text-sm mb-4 flex items-center gap-2 text-blue-200">
              ...
              <span>›</span>
              <Link href="/en/browse/cities" className="hover:text-white transition-colors">Cities</Link>
              <span>›</span>
            ...
            <div className="flex items-center gap-4">
              ...
              <div>
                ...
                <p className="mt-2 text-blue-100">
                  {(total || 0).toLocaleString('en-CA')} businesses found
                </p>
              </div>
            </div>

            <p className="mt-4 text-blue-100 max-w-2xl">
              Discover local businesses in {cityName}. Find shops, professional services and more.
            </p>
          </div>
        </section>
          ...
          <div className="max-w-6xl mx-auto px-4">
            {(businesses || []).length > 0 ? (
              ...
              <div className="text-center py-16 bg-white rounded-xl">
                ...
                <p className="text-gray-500">
                  No businesses in this city at the moment.
                </p>
              </div>
            )}
            ...
            {totalPages > 1 && (
              <div className="flex justify-center items-center gap-2 mt-8">
                {page > 1 && (
                  <Link
                    href={`/en/city/${citySlug}?page=${page - 1}`}
                ...
                <div className="flex items-center gap-1">
                  {Array.from({ length: Math.min(5, totalPages) }, (_, i) => {
                    ...
                    return (
                      <Link
                        key={pageNum}
                        href={`/en/city/${citySlug}?page=${pageNum}`}
        ...
        <section className="py-12 bg-blue-900 text-white">
          <div className="max-w-4xl mx-auto px-4 text-center">
            ...
            <p className="text-blue-200 mb-6">
              Add your business to our directory for free and increase your local visibility.
            </p>
            <Link
