        ...
        <div className="max-w-md w-full mx-4">
          ...
          <div className="bg-white rounded-2xl shadow-xl p-8">
            ...
            <p className="text-gray-600 text-center mb-6">
              Access your account to manage your business listings
            </p>
            ...
            <p className="mt-6 text-center text-gray-600">
              ...
              <Link href="/en/register" className="text-blue-600 hover:underline font-medium">
                Create an account
              </Link>
            </p>
          </div>
          ...
          <div className="mt-8 bg-blue-50 rounded-xl p-6">
            <h2 className="font-semibold text-gray-900 mb-3">Account benefits</h2>
