  ...
  fr: {
    translation: {
      ...
      home: {
        ...
        thanksTitle: 'Merci',
        thanksSubtitle: 'Ces entreprises ont contribué au développement de notre plateforme',
        newBusinessesTitle: 'Nouvelles fiches créées',
        newBusinessesSubtitle: 'Merci à toutes les entreprises qui se joignent à notre plateforme ! Ensemble, nous créons le répertoire le plus riche et le plus unique du Québec.',
      ...
      business: {
        ...
        unclaimedInfoSource: 'Les informations affichées proviennent de sources publiques ou ont été fournies par l\'entreprise elle-même.',
      ...
      myBusinesses: {
        ...
        noBusinessDescription: 'Vous n\'avez pas encore ajouté d\'entreprise à l\'annuaire.',
        addFirst: 'Ajouter ma première entreprise',
        viewListing: 'Voir la fiche',
        edit: 'Modifier',
        delete: 'Supprimer',
        deleteTitle: 'Supprimer cette entreprise',
        foundedIn: 'Fondée en',
        franchise: 'Franchise',
        accessDenied: 'Accès refusé',
        mustBeLoggedIn: 'Vous devez être connecté pour voir vos entreprises.',
        signIn: 'Se connecter',
        loading: 'Chargement de vos entreprises...',
        backHome: 'Retour à l\'accueil',
        deleteError: 'Erreur lors de la suppression de l\'entreprise. Veuillez réessayer.'
      },
      editBusiness: {
        ...
        required: '*',
        unauthorizedEdit: 'Vous n\'êtes pas autorisé à modifier cette entreprise',
        servicesOffered: 'Services offerts',
        servicesHelp: 'Listez les services que vous offrez (maximum 20)',
        images: 'Images',
        uploading: 'Téléversement...',
        uploadImages: 'Téléverser les images',
        businessName: 'Nom de l\'entreprise',
        businessNamePlaceholder: 'Ex: Restaurant Le Gourmet',
        slug: 'URL personnalisée (slug)',
        slugPlaceholder: 'mon-entreprise',
        slugAvailable: 'Ce slug est disponible',
        finalUrl: 'URL finale:',
        description: 'Description',
        descriptionPlaceholder: 'Décrivez votre entreprise...',
        characters: 'caractères',
        businessSize: 'Taille de l\'entreprise',
        selectOption: 'Sélectionnez...',
        establishedYear: 'Année de fondation',
        yearPlaceholder: 'Ex: 2015',
        isFranchise: 'Cette entreprise est une franchise',
        phone: 'Téléphone',
        phonePlaceholder: 'Ex: (514) 555-1234',
        email: 'Email',
        emailPlaceholder: 'contact@entreprise.com',
        showEmail: 'Afficher le courriel publiquement sur la fiche d\'entreprise',
        website: 'Site web',
        websitePlaceholder: 'https://www.entreprise.com',
        socialNetworks: 'Réseaux sociaux',
        facebookPlaceholder: 'https://www.facebook.com/votreentreprise',
        instagramPlaceholder: 'https://www.instagram.com/votreentreprise',
        twitterPlaceholder: 'https://x.com/votreentreprise',
        linkedinPlaceholder: 'https://www.linkedin.com/company/votreentreprise',
        threadsPlaceholder: 'https://www.threads.net/@votreentreprise',
        tiktokPlaceholder: 'https://www.tiktok.com/@votreentreprise',
        address: 'Adresse',
        addressPlaceholder: '123 Rue Principale',
        addressLine2: 'Adresse (ligne 2)',
        addressLine2Placeholder: 'Bureau 200',
        city: 'Ville',
        cityPlaceholder: 'Ex: Vaudreuil-Dorion, Montréal, Québec...',
        postalCode: 'Code postal',
        postalCodePlaceholder: 'H1A 1A1',
        regionDetected: 'Région détectée',
        latitude: 'Latitude',
        latitudePlaceholder: '45.5017',
        latitudeHelp: 'Coordonnée GPS Nord-Sud (ex: 45.5017)',
        longitude: 'Longitude',
        longitudePlaceholder: '-73.5673',
        longitudeHelp: 'Coordonnée GPS Est-Ouest (ex: -73.5673)',
        gpsInstructions: 'Comment obtenir les coordonnées GPS?',
        gpsMethod: 'Méthode: Google Maps',
        gpsStep1: 'Allez sur',
        gpsStep2: 'Tapez votre adresse dans la barre de recherche',
        gpsStep3: 'Clic droit sur le marqueur rouge (ou sur l\'emplacement exact)',
        gpsStep4: 'Cliquez sur les coordonnées qui apparaissent en premier dans le menu',
        gpsStep5: 'Les coordonnées sont copiées! Collez-les ici (format: 45.5017, -73.5673)',
        gpsWarning: 'Important:',
        gpsWarningText: 'Sans coordonnées GPS, la carte Google Maps ne s\'affichera pas sur la page de votre entreprise.',
        productsServices: 'Services et produits',
        productsServicesPlaceholder: 'Ex: Consultation gratuite, Livraison à domicile, Service 24/7...',
        productsServicesHelp: 'Séparez les services par des virgules ou des retours à la ligne',
        logoLabel: 'Logo de l\'entreprise (format carré 1:1 recommandé)',
        logoHelp: 'Le logo sera automatiquement compressé en format WebP',
        galleryLabel: 'Galerie photos (jusqu\'à 10 images)',
        galleryHelp: 'Les images seront automatiquement compressées en format WebP',
        currentImages: 'Images actuelles',
        deleteImage: 'Supprimer cette image',
        uploadingProgress: 'Téléversement...',
        logoProgress: 'Logo:',
        galleryProgress: 'Galerie:',
        loading: 'Chargement...',
  ...
  en: {
    translation: {
      ...
      home: {
        ...
        thanksTitle: 'Thanks',
        thanksSubtitle: 'These businesses have contributed to the development of our platform',
        newBusinessesTitle: 'Newly Created Listings',
        newBusinessesSubtitle: 'Thank you to all businesses joining our platform! Together, we are creating the richest and most unique business directory in Quebec.',
      ...
      business: {
        ...
        unclaimedInfoSource: 'The information displayed comes from public sources or was provided by the business itself.',
      ...
      myBusinesses: {
        ...
        noBusinessDescription: 'You haven\'t added any businesses to the directory yet.',
        addFirst: 'Add my first business',
        viewListing: 'View listing',
        edit: 'Edit',
        delete: 'Delete',
        deleteTitle: 'Delete this business',
        foundedIn: 'Founded in',
        franchise: 'Franchise',
        accessDenied: 'Access denied',
        mustBeLoggedIn: 'You must be logged in to view your businesses.',
        signIn: 'Sign in',
        loading: 'Loading your businesses...',
        backHome: 'Back to home',
        deleteError: 'Error deleting business. Please try again.'
      },
      editBusiness: {
        title: 'Edit business',
        backToListing: 'Back to listing',
        basicInfo: 'Basic information',
        logoPhotos: 'Logo & Photos',
        contact: 'Contact',
        hours: 'Hours',
        categories: 'Categories',
        services: 'Services',
        ...
        required: '*',
        unauthorizedEdit: 'You are not authorized to edit this business',
        servicesOffered: 'Services offered',
        servicesHelp: 'List the services you offer (maximum 20)',
        images: 'Images',
        uploading: 'Uploading...',
        uploadImages: 'Upload images',
        businessName: 'Business name',
        businessNamePlaceholder: 'E.g.: Le Gourmet Restaurant',
        ...
        isFranchise: 'This business is a franchise',
        phone: 'Phone',
        phonePlaceholder: 'E.g.: (514) 555-1234',
        email: 'Email',
        emailPlaceholder: 'contact@business.com',
        showEmail: 'Display email publicly on business listing',
        website: 'Website',
        websitePlaceholder: 'https://www.business.com',
        socialNetworks: 'Social networks',
        facebookPlaceholder: 'https://www.facebook.com/yourbusiness',
        instagramPlaceholder: 'https://www.instagram.com/yourbusiness',
        twitterPlaceholder: 'https://x.com/yourbusiness',
        linkedinPlaceholder: 'https://www.linkedin.com/company/yourbusiness',
        threadsPlaceholder: 'https://www.threads.net/@yourbusiness',
        tiktokPlaceholder: 'https://www.tiktok.com/@yourbusiness',
        address: 'Address',
        addressPlaceholder: '123 Main Street',
        addressLine2: 'Address (line 2)',
        addressLine2Placeholder: 'Suite 200',
        city: 'City',
        cityPlaceholder: 'E.g.: Vaudreuil-Dorion, Montreal, Quebec...',
        postalCode: 'Postal code',
        postalCodePlaceholder: 'H1A 1A1',
        regionDetected: 'Detected region',
        latitude: 'Latitude',
        latitudePlaceholder: '45.5017',
        latitudeHelp: 'GPS coordinate North-South (e.g.: 45.5017)',
        longitude: 'Longitude',
        longitudePlaceholder: '-73.5673',
        longitudeHelp: 'GPS coordinate East-West (e.g.: -73.5673)',
        gpsInstructions: 'How to get GPS coordinates?',
        gpsMethod: 'Method: Google Maps',
        gpsStep1: 'Go to',
        gpsStep2: 'Type your address in the search bar',
        gpsStep3: 'Right-click on the red marker (or exact location)',
        gpsStep4: 'Click on the coordinates that appear first in the menu',
        gpsStep5: 'Coordinates copied! Paste them here (format: 45.5017, -73.5673)',
        gpsWarning: 'Important:',
        gpsWarningText: 'Without GPS coordinates, the Google Maps map will not display on your business page.',
        productsServices: 'Products and services',
        productsServicesPlaceholder: 'E.g.: Free consultation, Home delivery, 24/7 service...',
        productsServicesHelp: 'Separate services with commas or line breaks',
        logoLabel: 'Business logo (square 1:1 format recommended)',
        logoHelp: 'Logo will be automatically compressed to WebP format',
        galleryLabel: 'Photo gallery (up to 10 images)',
        galleryHelp: 'Images will be automatically compressed to WebP format',
