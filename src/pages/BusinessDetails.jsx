                ...
                <div className="contact-section">
                  ...
                  <div className="social-media-links">
                    {business.facebook_url && (
                      <a href={business.facebook_url} target="_blank" rel={`noopener noreferrer${(business.data_source === 'req' && !isClaimed) ? ' nofollow' : ''}`} className="social-link facebook" title="Facebook">
                    ...
                    {business.instagram_url && (
                      <a href={business.instagram_url} target="_blank" rel={`noopener noreferrer${(business.data_source === 'req' && !isClaimed) ? ' nofollow' : ''}`} className="social-link instagram" title="Instagram">
                        <svg width="24" height="24" viewBox="0 0 24 24" fill="currentColor">
                    ...
                    {business.twitter_url && (
                      <a href={business.twitter_url} target="_blank" rel={`noopener noreferrer${(business.data_source === 'req' && !isClaimed) ? ' nofollow' : ''}`} className="social-link twitter" title="X (Twitter)">
                        <svg width="24" height="24" viewBox="0 0 24 24" fill="currentColor">
                    ...
                    {business.linkedin_url && (
                      <a href={business.linkedin_url} target="_blank" rel={`noopener noreferrer${(business.data_source === 'req' && !isClaimed) ? ' nofollow' : ''}`} className="social-link linkedin" title="LinkedIn">
                        <svg width="24" height="24" viewBox="0 0 24 24" fill="currentColor">
                    ...
                    {business.threads_url && (
                      <a href={business.threads_url} target="_blank" rel={`noopener noreferrer${(business.data_source === 'req' && !isClaimed) ? ' nofollow' : ''}`} className="social-link threads" title="Threads">
                        <img src="/images/socialnetwork/threads.svg" alt="Threads" width="24" height="24" />
                      </a>
                    )}
                    {business.tiktok_url && (
                      <a href={business.tiktok_url} target="_blank" rel={`noopener noreferrer${(business.data_source === 'req' && !isClaimed) ? ' nofollow' : ''}`} className="social-link tiktok" title="TikTok">
                        <svg width="24" height="24" viewBox="0 0 24 24" fill="currentColor">
