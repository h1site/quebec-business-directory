...
function AnimatedCounter({ value, suffix = '', delay = 0 }: { value: number; suffix?: string; delay?: number }) {
  ...
  return (
    <span ref={ref}>
      {count.toLocaleString('en-CA')}{suffix}
    </span>
  )
}
  ...
  return (
    <section className="py-16 bg-blue-900 text-white overflow-hidden" ref={ref}>
      <div className="max-w-7xl mx-auto px-4">
        ...
        >
          <StatItem value={600000} suffix="+" label="Businesses listed" delay={0} />
          <StatItem value={17} label="Quebec regions" delay={0.2} />
          <StatItem value={100} suffix="%" label="Free" delay={0.4} />
        </motion.div>
      </div>
