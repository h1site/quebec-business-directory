...
console.log('🧹 RÉINITIALISATION act_econ_code="0001" → main_category_id=NULL\n');
console.log('═'.repeat(80));

// 1. Compter combien d'entreprises à nettoyer
...
console.log(`\n📊 Entreprises à nettoyer: ${totalToClean?.toLocaleString()}`);
...
while (hasMore) {
  ...
  // Limite de sécurité
  if (passNumber > 5000) {
    console.log('⚠️  Limite de 5000 passes atteinte');
    break;
  }
...
if (remaining === 0) {
  console.log('✅ PARFAIT! Toutes les entreprises "0001" ont main_category_id=NULL');
} else {
...
console.log('\n💡 Les entreprises avec code "0001" n\'apparaîtront plus dans les catégories');
