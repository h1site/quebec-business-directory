...
console.log('🗑️  NETTOYAGE DES ENTREPRISES 9XXXXX CANADA/QUEBEC INC/LTÉE\n');
console.log('═══════════════════════════════════════════════════════════\n');
...
// Pattern: commence par 9 suivi de chiffres, termine par CANADA/QUEBEC INC/LTÉE
// Exemples: "90895 CANADA LTÉE", "9123456 CANADA INC", "9158 QUEBEC INC"
const pattern = /^9\d+\s+(canada|quebec)\s+(inc\.?|ltée?\.?|limited|limitée)$/i;
...
console.log(`✅ Trouvé ${stats.found} entreprises "9XXXXX CANADA/QUEBEC INC/LTÉE"\n`);
...
console.log('📋 Exemples (premiers 50):');
toDelete.slice(0, 50).forEach(b => {
