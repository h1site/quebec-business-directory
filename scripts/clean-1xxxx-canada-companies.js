...
console.log('🗑️  NETTOYAGE DES ENTREPRISES 1XXXXX CANADA INC/LTÉE\n');
console.log('═══════════════════════════════════════════════════════════\n');
...
// Pattern: commence par 1 suivi de chiffres, termine par CANADA INC/LTÉE
// Exemples: "106798 CANADA LTÉE", "1234567 CANADA INC", "175246 CANADA INC."
const pattern = /^1\d+\s+(canada)\s+(inc\.?|ltée?\.?|limited|limitée)$/i;
...
console.log(`✅ Trouvé ${stats.found} entreprises "1XXXXX CANADA INC/LTÉE"\n`);
